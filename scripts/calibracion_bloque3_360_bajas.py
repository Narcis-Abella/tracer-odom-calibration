...
# --- BLOQUE 3 -- 360 grados vel bajas  (120 runs, ~44 min) ---
CSV_FILE = "resultados_bloque3_360_bajas.csv"

# PLAN: (vel_max, acel, angulo_deg, repeticiones, direccion)
#   direccion: +1 = CCW, -1 = CW
PLAN = []
# -- 360 grados --
PLAN.append((0.3, 0.5, 360, 5, +1))
PLAN.append((0.3, 0.5, 360, 5, -1))
PLAN.append((0.3, 1.0, 360, 5, +1))
PLAN.append((0.3, 1.0, 360, 5, -1))
PLAN.append((0.3, 2.0, 360, 5, +1))
PLAN.append((0.3, 2.0, 360, 5, -1))
PLAN.append((0.35, 0.5, 360, 5, +1))
PLAN.append((0.35, 0.5, 360, 5, -1))
PLAN.append((0.35, 1.0, 360, 5, +1))
PLAN.append((0.35, 1.0, 360, 5, -1))
PLAN.append((0.35, 2.0, 360, 5, +1))
PLAN.append((0.35, 2.0, 360, 5, -1))
PLAN.append((0.4, 0.5, 360, 5, +1))
PLAN.append((0.4, 0.5, 360, 5, -1))
PLAN.append((0.4, 1.0, 360, 5, +1))
PLAN.append((0.4, 1.0, 360, 5, -1))
PLAN.append((0.4, 2.0, 360, 5, +1))
PLAN.append((0.4, 2.0, 360, 5, -1))
PLAN.append((0.5, 0.5, 360, 5, +1))
PLAN.append((0.5, 0.5, 360, 5, -1))
PLAN.append((0.5, 1.0, 360, 5, +1))
PLAN.append((0.5, 1.0, 360, 5, -1))
PLAN.append((0.5, 2.0, 360, 5, +1))
PLAN.append((0.5, 2.0, 360, 5, -1))
