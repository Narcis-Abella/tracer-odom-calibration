...
# --- BLOQUE 1 -- 90 grados  (270 runs, ~38 min) ---
CSV_FILE = "resultados_bloque1_90.csv"

# PLAN: (vel_max, acel, angulo_deg, repeticiones, direccion)
#   direccion: +1 = CCW, -1 = CW
PLAN = []
# -- 90 grados --
PLAN.append((0.3, 0.5, 90, 5, +1))
PLAN.append((0.3, 0.5, 90, 5, -1))
PLAN.append((0.3, 1.0, 90, 5, +1))
PLAN.append((0.3, 1.0, 90, 5, -1))
PLAN.append((0.3, 2.0, 90, 5, +1))
PLAN.append((0.3, 2.0, 90, 5, -1))
PLAN.append((0.35, 0.5, 90, 5, +1))
PLAN.append((0.35, 0.5, 90, 5, -1))
PLAN.append((0.35, 1.0, 90, 5, +1))
PLAN.append((0.35, 1.0, 90, 5, -1))
PLAN.append((0.35, 2.0, 90, 5, +1))
PLAN.append((0.35, 2.0, 90, 5, -1))
PLAN.append((0.4, 0.5, 90, 5, +1))
PLAN.append((0.4, 0.5, 90, 5, -1))
PLAN.append((0.4, 1.0, 90, 5, +1))
PLAN.append((0.4, 1.0, 90, 5, -1))
PLAN.append((0.4, 2.0, 90, 5, +1))
PLAN.append((0.4, 2.0, 90, 5, -1))
PLAN.append((0.5, 0.5, 90, 5, +1))
PLAN.append((0.5, 0.5, 90, 5, -1))
PLAN.append((0.5, 1.0, 90, 5, +1))
PLAN.append((0.5, 1.0, 90, 5, -1))
PLAN.append((0.5, 2.0, 90, 5, +1))
PLAN.append((0.5, 2.0, 90, 5, -1))
PLAN.append((0.6, 0.5, 90, 5, +1))
PLAN.append((0.6, 0.5, 90, 5, -1))
PLAN.append((0.6, 1.0, 90, 5, +1))
PLAN.append((0.6, 1.0, 90, 5, -1))
PLAN.append((0.6, 2.0, 90, 5, +1))
PLAN.append((0.6, 2.0, 90, 5, -1))
PLAN.append((0.8, 0.5, 90, 5, +1))
PLAN.append((0.8, 0.5, 90, 5, -1))
PLAN.append((0.8, 1.0, 90, 5, +1))
PLAN.append((0.8, 1.0, 90, 5, -1))
PLAN.append((0.8, 2.0, 90, 5, +1))
PLAN.append((0.8, 2.0, 90, 5, -1))
PLAN.append((1.0, 0.5, 90, 5, +1))
PLAN.append((1.0, 0.5, 90, 5, -1))
PLAN.append((1.0, 1.0, 90, 5, +1))
PLAN.append((1.0, 1.0, 90, 5, -1))
PLAN.append((1.0, 2.0, 90, 5, +1))
PLAN.append((1.0, 2.0, 90, 5, -1))
PLAN.append((1.5, 0.5, 90, 5, +1))
PLAN.append((1.5, 0.5, 90, 5, -1))
PLAN.append((1.5, 1.0, 90, 5, +1))
PLAN.append((1.5, 1.0, 90, 5, -1))
PLAN.append((1.5, 2.0, 90, 5, +1))
PLAN.append((1.5, 2.0, 90, 5, -1))
PLAN.append((2.0, 0.5, 90, 5, +1))
PLAN.append((2.0, 0.5, 90, 5, -1))
PLAN.append((2.0, 1.0, 90, 5, +1))
PLAN.append((2.0, 1.0, 90, 5, -1))
PLAN.append((2.0, 2.0, 90, 5, +1))
PLAN.append((2.0, 2.0, 90, 5, -1))
