...
# --- BLOQUE 4 -- 360 grados vel altas  (150 runs, ~32 min) ---
CSV_FILE = "resultados_bloque4_360_altas.csv"

# PLAN: (vel_max, acel, angulo_deg, repeticiones, direccion)
#   direccion: +1 = CCW, -1 = CW
PLAN = []
# -- 360 grados --
PLAN.append((0.6, 0.5, 360, 5, +1))
PLAN.append((0.6, 0.5, 360, 5, -1))
PLAN.append((0.6, 1.0, 360, 5, +1))
PLAN.append((0.6, 1.0, 360, 5, -1))
PLAN.append((0.6, 2.0, 360, 5, +1))
PLAN.append((0.6, 2.0, 360, 5, -1))
PLAN.append((0.8, 0.5, 360, 5, +1))
PLAN.append((0.8, 0.5, 360, 5, -1))
PLAN.append((0.8, 1.0, 360, 5, +1))
PLAN.append((0.8, 1.0, 360, 5, -1))
PLAN.append((0.8, 2.0, 360, 5, +1))
PLAN.append((0.8, 2.0, 360, 5, -1))
PLAN.append((1.0, 0.5, 360, 5, +1))
PLAN.append((1.0, 0.5, 360, 5, -1))
PLAN.append((1.0, 1.0, 360, 5, +1))
PLAN.append((1.0, 1.0, 360, 5, -1))
PLAN.append((1.0, 2.0, 360, 5, +1))
PLAN.append((1.0, 2.0, 360, 5, -1))
PLAN.append((1.5, 0.5, 360, 5, +1))
PLAN.append((1.5, 0.5, 360, 5, -1))
PLAN.append((1.5, 1.0, 360, 5, +1))
PLAN.append((1.5, 1.0, 360, 5, -1))
PLAN.append((1.5, 2.0, 360, 5, +1))
PLAN.append((1.5, 2.0, 360, 5, -1))
PLAN.append((2.0, 0.5, 360, 5, +1))
PLAN.append((2.0, 0.5, 360, 5, -1))
PLAN.append((2.0, 1.0, 360, 5, +1))
PLAN.append((2.0, 1.0, 360, 5, -1))
PLAN.append((2.0, 2.0, 360, 5, +1))
PLAN.append((2.0, 2.0, 360, 5, -1))
